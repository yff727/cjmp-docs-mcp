...
**本项目为个人爱好者制作的 Demo 工程，并非 CJMP 官方项目。**

- 本项目的 MCP 服务器和 Skill 文件均由 **GLM-5** 自动生成
- 仅供学习和参考使用，不保证内容的准确性和完整性
- 如发现错误或有改进建议，欢迎提交 Issue 或 Pull Request 指正
- 官方 CJMP 文档请访问：https://gitcode.com/CJMP
